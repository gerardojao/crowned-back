...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260608201402_RepuestoStockFacturadoHistory'
)
BEGIN
    ...
    IF @var6 IS NOT NULL EXEC(N'ALTER TABLE [RepuestoStock] DROP CONSTRAINT [' + @var6 + '];');
...
BEGIN
    ...
    IF @var7 IS NOT NULL EXEC(N'ALTER TABLE [RepuestoStock] DROP CONSTRAINT [' + @var7 + '];');
